...
# define the toolchain and target names for 17.1.1
#TOOLCHAIN_NAME="toolchain-mipsel_24kc_gcc-5.4.0_musl-1.1.16"
#TARGET_NAME="target-mipsel_24kc_musl-1.1.16"

# define the toolchain and target names for 19.0.3
#TOOLCHAIN_NAME="toolchain-mipsel_24kc_gcc-7.5.0_musl"
#TARGET_NAME="target-mipsel_24kc_musl"

# define the toolchain and target names for 23
TOOLCHAIN_NAME="toolchain-mipsel_24kc_gcc-12.3.0_musl"
TARGET_NAME="target-mipsel_24kc_musl"
...
#TOOLCHAIN_CFLAGS="-std=gnu99 -Wall -Wextra"
